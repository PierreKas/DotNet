...
namespace Scaffoding.Controllers
{
    public class AttendeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "uuid,FullName,phone,address")] Attendee attendee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "uuid,FullName,phone,address")] Attendee attendee)
        {
            if (ModelState.IsValid)
            {
